...
class Config:
    ...
    def load(cls, path: str | Path) -> "Config":
        ...
        mail_tracking_cfg.setdefault("provider", "gmail")
        mail_tracking_cfg.setdefault("imap_host", "imap.gmail.com")
        mail_tracking_cfg.setdefault("imap_port", 993)
        mail_tracking_cfg.setdefault("username", "")
        mail_tracking_cfg.setdefault("app_password", "")
        mail_tracking_cfg.setdefault("mailboxes", ["INBOX", "[Gmail]/All Mail"])
